...
public abstract class PWIPlayerLastLocInWorldData extends PWIMetaDataValueAbstract<Map<String,Location>> {
    ...
    public PWIPlayerLastLocInWorldData(Player player) {
        super(plugin);
        this.playerUUID = player.getUniqueId();
    }

    public PWIPlayerLastLocInWorldData(String playerUUID) {
        super(plugin);
